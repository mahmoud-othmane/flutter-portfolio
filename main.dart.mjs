...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      DH: x0 => x0.value,
      DI: x0 => x0.debugSkipFontRetryDelay,
      ...
      KJ: (x0,x1) => x0.getModifierState(x1),
      L: o => o === undefined,
      ...
      TE: o => o.length,
      TF: s => s.trimRight(),
      TG: (x0,x1) => x0.getRandomValues(x1),
      ...
      VE: x0 => x0.language,
      VF: x0 => x0.button,
      VG: l => new DataView(new ArrayBuffer(l)),
      VH: (x0,x1) => { x0.name = x1 },
      VI: x0 => x0.frameCount,
      ...
      aG: () => new WeakMap(),
      aH: (x0,x1) => x0.removeAttribute(x1),
      aI: x0 => x0.close(),
      aJ: x0 => x0.abort(),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: o => {
      ...
      bG: (x0,x1,x2,x3) => x0.pushState(x1,x2,x3),
      bH: x0 => x0.isConnected,
      ...
      dF: (x0,x1) => { x0.name = x1 },
      dG: x0 => x0.search,
      dH: (x0,x1) => x0.getElementsByClassName(x1),
      ...
      gF: x0 => x0.firstChild,
      gG: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      ...
      rI: (x0,x1) => { x0.max = x1 },
      rJ: () => globalThis.removeSplashFromWeb(),
      s: () => ({}),
      ...
      yG: (x0,x1,x2) => x0.setSelectionRange(x1,x2),
